...
<div style="border: 1px solid #333; border-radius: 8px; overflow: hidden; margin: 16px 0;">
  <iframe src="/parallax-presentations/demos/expand-image.html" style="width:100%;height:260px;border:none"></iframe>
</div>
...
<div style="border: 1px solid #333; border-radius: 8px; overflow: hidden; margin: 16px 0;">
  <iframe src="/parallax-presentations/demos/popup-image.html" style="width:100%;height:260px;border:none"></iframe>
</div>
