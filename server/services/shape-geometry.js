...
// Written by scripts/copy-click-actions.js from client/src/utils/shapeGeometry.js;
...
const CLOSED_SHAPES = ['rect', 'rounded-rect', 'circle', 'triangle', 'diamond', 'arrow-right', 'star']
...
const outlinePath = points => `M${points.map(p => p.join(' ')).join('L')}Z`
...
module.exports = { CLOSED_SHAPES, shapeParts, shapeOutline, outlinePath, shapeSvgString }
